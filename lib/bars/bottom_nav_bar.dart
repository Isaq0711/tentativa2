  ...
  Future<void> _onItemTapped(int index) async {
    setState(() {
      ...
      if (_selectedIndex == 2) {
        Navigator.push(
          context,
          MaterialPageRoute(builder: (context) => ProfileScreen(username: _userData.username)), 
        );
          ...
          icon: InkWell(
            ...
            onTap: () {
              Navigator.pushReplacement(
                context,
                MaterialPageRoute(
                  builder: (context) => ProfileScreen(username: _userData.username), 
                ),
              );
            },
          ),
